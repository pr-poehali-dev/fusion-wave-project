    ...
    <section className="py-12 md:py-20 bg-black">
      <div className="container mx-auto px-4">
        <div className="text-center mb-10 md:mb-16">
          <h2 className="text-2xl md:text-4xl font-bold text-white mb-4 md:mb-6 font-orbitron">Частые вопросы</h2>
        ...
        <div className="max-w-4xl mx-auto">
          <Accordion type="single" collapsible className="w-full">
            {faqs.map((faq, index) => (
              <AccordionItem key={index} value={`item-${index}`} className="border-green-500/20 mb-3">
                <AccordionTrigger className="text-left text-sm md:text-base font-semibold text-white hover:text-green-400 font-orbitron px-3 md:px-6 py-3 md:py-4">
                  {faq.question}
                </AccordionTrigger>
                <AccordionContent className="text-gray-300 leading-relaxed px-3 md:px-6 pb-3 md:pb-4 text-sm md:text-base font-space-mono">
                  {faq.answer}
                </AccordionContent>
              </AccordionItem>
            ))}
